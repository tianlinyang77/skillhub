...
- Treat `staging/` as non-published catalog-owned candidate space; product-owned candidates stay in their product repositories.
...
- Run `npx skills add . --list` after structural changes and confirm staging and templates are not discovered.
