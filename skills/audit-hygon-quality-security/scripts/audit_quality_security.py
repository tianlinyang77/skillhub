...
"""Thin Skill adapter for the shared quality-security engine."""
...
def _engine_root() -> Path:
    ...
    for root in candidates:
        if (root / "src/hygon_quality_security/cli.py").is_file():
            return root
    raise RuntimeError(
...
def main() -> int:
    ...
    from hygon_quality_security.cli import main as governance_main

    return governance_main(sys.argv[1:])
